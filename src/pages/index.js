...
export default () => (
    ...
    <Helmet>
        ...
        <div>
            ...
            <h3>Work</h3>
            <p>Some call me Producer, Project Manager or Product Owner. I just see it as getting things done.</p>
            <p>At <a href="https://www.maze-theory.com" target="_blank" rel="noopener">Maze Theory</a> I'm working on a currently unannounced major VR title for PlayStation 4 and PC.</p>
